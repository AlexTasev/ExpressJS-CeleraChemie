module.exports = (payload) => {
  ...
  if (!payload || typeof payload.logoUrl !== 'string' || !payload.logoUrl.startsWith('http')) {
    isFormValid = false;
    errors.description = 'Image URL must be a valid URL.';
  }

  if (!payload || typeof payload.brandWebSite !== 'string' || !payload.brandWebSite.startsWith('http')) {
    isFormValid = false;
  ...
  if (!payload || typeof payload.catalogueUrl !== 'string' || !payload.catalogueUrl.startsWith('http')) {
    isFormValid = false;
